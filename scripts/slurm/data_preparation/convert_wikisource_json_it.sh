...
#SBATCH --output=/leonardo/home/userexternal/lmoroni0/__Work/llm-foundry/logs/data-processing/wikisource_it-%x-%j.out         # Name of stdout output file
#SBATCH --error=/leonardo/home/userexternal/lmoroni0/__Work/llm-foundry/logs/data-processing/wikisource_it-%x-%j.err          # Name of stderr error file
...
python scripts/data_prep/convert_dataset_json.py \
  --path $SCRATCH/data/json/cpt/it/wikisource \
  --out_root $SCRATCH/data/mds/cpt/it/wikisource/train \
  --split train \
