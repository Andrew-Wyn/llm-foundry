...
#SBATCH --output=/leonardo/home/userexternal/lmoroni0/__Work/llm-foundry/logs/data-processing/flan-%x-%j.out         # Name of stdout output file
#SBATCH --error=/leonardo/home/userexternal/lmoroni0/__Work/llm-foundry/logs/data-processing/flan-%x-%j.err          # Name of stderr error file
...
python scripts/data_prep/convert_dataset_json.py \
  --path $SCRATCH/data/json/cpt/en/flan_processed \
  --out_root $SCRATCH/data/mds/cpt/en/flan/train \
  --split train \
