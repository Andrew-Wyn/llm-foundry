...
#SBATCH --output=/leonardo/home/userexternal/lmoroni0/__Work/llm-foundry/logs/data-processing/fineweb-%x-%j.out         # Name of stdout output file
#SBATCH --error=/leonardo/home/userexternal/lmoroni0/__Work/llm-foundry/logs/data-processing/fineweb-%x-%j.err          # Name of stderr error file
...
CC_NAME="CC-MAIN-2024-33"

echo "Processing CC  ${CC_NAME}"

python scripts/data_prep/convert_dataset_json.py \
  --path $SCRATCH/data/json/cpt/en/fineweb/$CC_NAME \
  --out_root $SCRATCH/data/mds/cpt/en/fineweb/$CC_NAME/train \
  --split train \
