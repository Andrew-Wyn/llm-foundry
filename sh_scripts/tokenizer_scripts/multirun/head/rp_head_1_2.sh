...
mkdir -p /leonardo_scratch/large/userexternal/lcolosi0/minerva/data/processed/it/redpajama-head/1/2/train
echo "Saving to /leonardo_scratch/large/userexternal/lcolosi0/minerva/data/processed/it/redpajama-head/1/2/train"

python scripts/data_prep/convert_dataset_json.py     --path "/leonardo_scratch/large/userexternal/lcolosi0/minerva/data/raw/redpajamas-head/1/2"     --out_root "/leonardo_scratch/large/userexternal/lcolosi0/minerva/data/processed/it/redpajama-head/1/2/train"     --split train     --concat_tokens 4096     --tokenizer sapienzanlp/Minerva-7B-base-v1.0     --max_tokens 1_000_000_000_000_000 # equivalent to 2000 steps omitt to process whole dataset
