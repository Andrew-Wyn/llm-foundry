...
for index in {1..9}; do
    DATA=/leonardo_scratch/large/userexternal/lcolosi0/minerva/data/raw/redpajamas-middle/$index

    OUTPUT_DIR=/leonardo_scratch/large/userexternal/lcolosi0/minerva/data/processed/it/redpajama-middle/$index/train
    mkdir -p $OUTPUT_DIR
