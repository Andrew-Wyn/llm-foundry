...
#SBATCH --job-name=CC-MAIN-2024-10                        # Job name
...
# echo "proicessing CC-MAIN-2024-10"
# HF_HUB_OFFLINE=0
# python  <<'PYCODE'
...
# ds = load_dataset(
#   "parquet",
#   data_files={"train": "/leonardo_scratch/large/userexternal/lcolosi0/minerva/data/raw/fineweb/shrad_CC-MAIN-2024-10/datasets--HuggingFaceFW--fineweb/snapshots/0f039043b23fe1d4eed300b504aa4b4a68f1c7ba/data/CC-MAIN-2024-10/*.parquet"}
# )
# ds.save_to_disk("/leonardo_scratch/large/userexternal/lcolosi0/minerva/data/raw/fineweb/hf_dataset/CC-MAIN-2024-10")
# PYCODE
# echo "done"

# DATA=/leonardo/prod/data/ai/culturax/2309/it/
DATA=/leonardo_scratch/large/userexternal/lcolosi0/minerva/data/raw/fineweb/hf_dataset/CC-MAIN-2024-10
TOKENIZER=sapienzanlp/Minerva-7B-base-v1.0

OUTPUT_DIR=/leonardo_scratch/large/userexternal/lcolosi0/minerva/data/processed/en/fineweb/CC-MAIN-2024-10
