...
DATA=/leonardo_scratch/large/userexternal/lcolosi0/minerva/data/raw/wikipedia/en
...
OUTPUT_DIR=/leonardo_scratch/large/userexternal/lcolosi0/minerva/data/processed/en/wikipedia
