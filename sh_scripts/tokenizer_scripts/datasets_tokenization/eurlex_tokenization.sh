...
DATA=/leonardo_scratch/large/userexternal/lcolosi0/minerva/data/raw/eurlex
...
OUTPUT_DIR=/leonardo_scratch/large/userexternal/lcolosi0/minerva/data/processed/en/eurlex
