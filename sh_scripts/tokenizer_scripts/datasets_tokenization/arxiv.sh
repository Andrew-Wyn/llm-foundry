...
DATA=/leonardo_scratch/large/userexternal/lcolosi0/minerva/data/raw/arxiv
OUTPUT_DIR=/leonardo_scratch/large/userexternal/lcolosi0/minerva/data/processed/en/arxiv/train
