...
#SBATCH --output=/leonardo/home/userexternal/lcolosi0/minerva/llm-foundry/logs/tests/%x-%j.out         # Name of stdout output file
#SBATCH --error=/leonardo/home/userexternal/lcolosi0/minerva/llm-foundry/logs/tests/%x-%j.err          # Name of stderr error file
...
python "$BASE_DIR"/tests/eval/test_minerva.py
